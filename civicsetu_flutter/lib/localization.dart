...
class AppLocalizations {
  ...
  static const TranslationMap _base = {
    ...
    'auth.title': 'Secure sign in for CIVICSETU',
    'auth.subtitle':
        'Register with email, sign in with Google, and keep your civic history synced to the cloud.',
    'auth.signIn': 'Sign In',
    'auth.signUp': 'Sign Up',
    ...
    'auth.passwordTooShort': 'Use at least 6 characters for the password.',
    'auth.continueWithGoogle': 'Continue with Google',
    'auth.orContinueWith': 'or continue with',
    'auth.signInHint':
        'Use the same account on any device to track reports and profile details.',
    'auth.registerHint':
        'After signup, complete your role profile once and then continue into the app.',
    'auth.profileSetup': 'Complete Your Profile',
    'auth.profileSubtitle':
        'Tell us your role and basic civic area details so the right portal opens after sign in.',
    'auth.role': 'Role',
    'auth.address': 'Address Details',
    'auth.organizationName': 'Organization or Company',
    'auth.completeProfile': 'Save Profile',
    'auth.sessionRestoring': 'Restoring secure session...',
